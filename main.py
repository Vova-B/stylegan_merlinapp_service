...
PRETRAINED_WEIGHT = '/root/workspace/stylegan_merlinapp_service/psp_ffhq_encode.pt'
TEST_DATA_DIR = '/root/workspace/stylegan_merlinapp_service/test_data'
RESULT_DATA_PATH = '/root/workspace/stylegan_merlinapp_service/test_data_res'
LATENT_DIRECTION_PATH = '/root/workspace/stylegan_merlinapp_service/latent_directions'
FACE_LANDMARKS_PATH = '/root/workspace/stylegan_merlinapp_service/shape_predictor_68_face_landmarks.dat'
ALIGN_IMAGE = True
...
def main():
    ...
    for i in tqdm(range(num_images)):
        ...
        with torch.no_grad():
            ...
            res_img, latents_dir = net(inp_img.to('cuda').float().unsqueeze(0), randomize_noise=False, return_latents=True)
